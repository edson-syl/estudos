...
class Db {
    ...
    public function getTotalDespesas() {
        $query = "SELECT SUM(total) AS total_despesas FROM tb_despesas";
        $stmt = $this->conexao->prepare($query);
        $stmt->execute();
...
$datasseletoras = explode('-', $_GET['datas']);
$ano = $datasseletoras[0];
$mes = $datasseletoras[1];
